...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center bg-dark text-right">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                           ...
                                           value="{{ old('email', 'admin@demo.com') }}" required autocomplete="email"
                                           autofocus
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                           ...
                                           name="password" required autocomplete="current-password" value="mo saber"
