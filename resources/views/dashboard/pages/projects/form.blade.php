                                        ...
                                        >
                                            ...
                                            @isset($project)
                                                <div class="form-group text-center">
                                                    <img src="{{ asset('storage/' .$project->image) }}" style="max-width: 100%">
                                                </div>
                                            @endisset
                                            <div class="form-group">
                                            ...
                                            @isset($project)
                                                <div class="form-group text-center">
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-8">
                                                            <img src="{{ asset('storage/' .$project->cover_image) }}" style="max-width: 100%">
                                                        </div>
                                                    </div>
                                                </div>
                                            @endisset
                                                ...
                                                <div class="row justify-content-center">
                                                    @foreach ($project->photos()->get() as $photo)
                                                        <div class="col-lg-4 mb-4">
                                                            <img src="{{ asset('storage/' .$photo->project_images) }}" style="max-width: 100%"/>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endisset
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-primary @isset($project) btn-success @endisset">
